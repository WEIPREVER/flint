          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="flintApp.statements.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {statementsList.map((statements, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{statements.user ? <Link to={`/bank-account/${statements.user.id}`}>{statements.user.login}</Link> : ''}</td>
