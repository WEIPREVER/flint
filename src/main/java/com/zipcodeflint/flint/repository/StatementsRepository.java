...
public interface StatementsRepository extends JpaRepository<Statements, Long> {
    ...
    @Query(
        value = "select distinct statements from Statements statements left join fetch statements.user",
    ...
    @Query("select distinct statements from Statements statements left join fetch statements.user")
    List<Statements> findAllWithToOneRelationships();

    @Query("select statements from Statements statements left join fetch statements.user where statements.id =:id")
